...
for a in range(2,65):
	...
	def run():
		...
		cell_obj = sheet_obj.cell(row=int(a), column=1)
		...
		if not args.get("input", False):
			...
			vs = cv2.VideoCapture("videos/"+cell_obj.value)
		...
		while True:
			...
			column = "c" + str(a);
			sheet[column] = "Total sortie " + str(totalUp) + " Total entree " + str(totalDown)
		...
		wb_obj.save(filename="Performance.xlsx")
	...
	run()
	# get real result
	wb_obj1 = openpyxl.load_workbook("Performance.xlsx")
	sheet_obj1 = wb_obj1.active

	cell_obj1 = sheet_obj1.cell(row=int(a), column=2)
	arraySplit = str(cell_obj1.value).split()
	up = arraySplit[2]
	down = arraySplit[5]



	if int(down) != totalDown or int(up) != totalUp:
		cell_obj1 = sheet_obj1.cell(row=int(a), column=2)
		cell_obj1.fill = PatternFill(start_color='FF0000', end_color='FF0000', fill_type="solid")
		cell_obj1 = sheet_obj1.cell(row=int(a), column=1)
		cell_obj1.fill =PatternFill(start_color='FF0000', end_color='FF0000', fill_type="solid")
		cell_obj1 = sheet_obj1.cell(row=int(a), column=3)
		cell_obj1.fill =PatternFill(start_color='FF0000', end_color='FF0000', fill_type="solid")

		wb_obj1.save('Performance.xlsx')
	else:
		cell_obj1 = sheet_obj1.cell(row=int(a), column=2)
		cell_obj1.fill = PatternFill(start_color='14e040', end_color='14e040', fill_type="solid")
		cell_obj1 = sheet_obj1.cell(row=int(a), column=1)
		cell_obj1.fill = PatternFill(start_color='14e040', end_color='14e040', fill_type="solid")
		cell_obj1 = sheet_obj1.cell(row=int(a), column=3)
		cell_obj1.fill = PatternFill(start_color='14e040', end_color='14e040', fill_type="solid")
